  ...
  return (
    <section className={`page-container py-[56px] md:py-[120px] ${className}`}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[var(--spacing-16x)] items-center">
          {/* Image */}
          ...
          {/* Content */}
          <div className="flex flex-col gap-[var(--spacing-6x)] order-1 md:order-2">
        ...
        {/* Second Row */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[var(--spacing-16x)] items-center mt-[var(--spacing-20x)]">
          {/* Content */}
